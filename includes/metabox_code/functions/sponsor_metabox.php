...
function add_country_sponsor_box() {
    add_meta_box(
        'country_m_box', // $id
        'Logo y URL', // $title 
        'show_country_sponsor_m_box', // $callback
        'dal_country_sponsor', // $page
        'normal', // $context
        'core'); // $priority
}
add_action('add_meta_boxes', 'add_country_sponsor_box');
...
$sponsor_meta_fields = array(
	array(
		...
		'desc'  => __('Sponsor logo','dal-functionality'),
		'id'    => $prefix.'logo',
		'type'  => 'image'
	),
	array(
		'label' => __('Sponsor link','dal-functionality'),
		'desc'  => __('Sponsor URL, must start with http://','dal-functionality'),
		'id'    => $prefix.'link',
		'type'  => 'link'
	),
	array(
		'label' => __('Sponsor description','dal-functionality'),
		'desc'  => __('Sponsor description','dal-functionality'),
		'id'    => $prefix.'desc_org',
		'type'  => 'textarea'
	),  
);
...
// Save the Data
function save_country_sponsor_meta($post_id) 
{
	global $sponsor_meta_fields;
	// verify nonce
...
add_action('save_post', 'save_country_sponsor_meta');